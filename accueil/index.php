            ...
            <div class='row'>
                ...
                <div class='col-md-9' style=' background:'>
                    ...
                    if (isset($_GET["categorie"])) {
                        require_once '../afficher/contenu_categorie.php';
                    } elseif (isset($_REQUEST["id_article"])) {
                        require_once '../afficher/contenu_article.php';
                    } elseif (isset($_GET["ajouter_article"])) {
                        require_once '../articles/Ajouter_Article.php';
                    } elseif (isset($_POST['submit_article'])) {               //Ajouter article
                        require_once '../articles/Action_Article.php';
                        echo '<br/><div class="alert alert-success text-center">Cet article va être traité avant de pulier!</div>';
                        ?>
                        ...
                        require_once '../afficher/article_de_auteur.php';
                    } else {
                        require_once '../afficher/contenu_accueil.php';
                    };
                    ?>
                </div>
